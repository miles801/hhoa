...
public class DynamicDataFilterImpl implements DynamicDataFilter {
    ...
    @Override
    public void addFilterCondition(Criteria criteria, String filterName, String fieldName, FilterFieldType filterFieldType) {
        ...
        if (accreditDataMap != null && !accreditDataMap.isEmpty()) {
            ...
            if (accreditDataList != null && !accreditDataList.isEmpty()) {
                // 设置标志位，表示已经设置了权限
                hasGrant = true;
