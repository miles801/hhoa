...
<body>
<div class="main condition-row-1" ng-app="oa.article.list" ng-controller="Ctrl">
                    ...
                    <div class="table-responsive panel panel-table">
                        <table class="table table-striped table-hover text-center">
                            ...
                            <tr bindonce ng-repeat="foo in beans.data" ng-cloak>
                                ...
                                <td bo-text="foo.summary|substr:20"></td>
                                <td bo-text="foo.keywords"></td>
                                <td bo-text="foo.authorName"></td>
                                <td bo-text="foo.publishTime|eccrmDatetime"></td>
                                ...
                                <td>
                                    ...
                                    <a class="cp" title="发布" ng-click="publish(foo.id);">
                                        <i class="icons ok"></i>
                                    </a>
                                </td>
                            </tr>
...
<script type="text/javascript" src="<%=contextPath%>/app/oa/article/list/article_list.js"></script>
</html>