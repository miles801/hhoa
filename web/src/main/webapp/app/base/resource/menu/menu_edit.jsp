                ...
                <form name="form" class="form-horizontal" role="form" >
                    ...
                    <div class="row" >
                        ...
                        <input type="text" name="name" class="col-2-half" placeholder="请输入功能名称" ng-model="menu.name"
                               validate validate-required validate-min-length="2" validate-max-length="20" maxlength="20" data-placement="right" validate-options="hasName" />

                        <div class="form-label col-1-half" >
                            <label >功能编号:</label >
                        </div >
                        <input type="text" name="code" class="col-2-half" ng-model="menu.code"
                               validate validate-required validate-max-length="40" maxlength="40" validate-options="hasCode" />

                        <div class="form-label col-1-half" >
                            <label >功能类型:</label >
                        </div >
                        <select id="type" ng-model="menu.type" ng-options="foo.value as foo.name for foo in types" class="col-2" > </select >
                    </div >
                    <div class="row" >
                        <div class="form-label col-1-half" >
                            <label >显示顺序:</label >
                        </div >
                        <input type="number" name="sequenceNo" class="col-2-half" placeholder="请输入一个正整数..." ng-model="menu.sequenceNo"
                        ...
                        <span class="col-2-half" >
                            <input type="checkbox" class="col" id="authorization" ng-model="menu.authorization" value="true" />
                        </span >
                    ...
                    <div class="row" >
                        ...
                        <div class="col-2-half" style="position: relative;" >
                            <input type="text" class="col-12" ztree-single="ztreeResource" ng-model="menu.resource.name" />
                            <span class="add-on" >
                    ...
                    <div class="row" style="margin-top: 5px;" >
                        ...
                        <div class="col-2" >
                            <select ng-model="menu.status" ng-options="foo.value as foo.name for foo in status" > </select >
                        </div >
                    </div >
                </form >
            </div >
